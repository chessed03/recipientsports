...
<body>
                    ...
                    <div class="product-preview-img-wrap">
                        ...
                        <a href="product-page.html">
                            <figure class="product-preview-img liquid">
                                <img src="{{ asset('themes/pixel-diamont-one/img/products/01.jpg') }}" alt="product-01">
                            </figure>
                        </a>
                        <!-- /PRODUCT PREVIEW IMG -->
                    </div>
            ...
            <div class="inventory-item-preview">
                ...
                <div class="product-preview small">
                    ...
                    <div class="product-preview-img-wrap">
                        ...
                        <a href="product-page.html">
                            <figure class="product-preview-img liquid">
                                <img src="{{ asset('themes/pixel-diamont-one/img/products/06.jpg') }}" alt="product-06">
                            </figure>
                        </a>
                        <!-- /PRODUCT PREVIEW IMG -->
                    </div>
            ...
            <div class="inventory-item-preview">
                ...
                <div class="product-preview small">
                    ...
                    <div class="product-preview-img-wrap">
                        ...
                        <a href="product-page.html">
                            <figure class="product-preview-img liquid">
                                <img src="{{ asset('themes/pixel-diamont-one/img/products/05.jpg') }}" alt="product-05">
                            </figure>
                        </a>
                        <!-- /PRODUCT PREVIEW IMG -->
                    </div>
            ...
            <div class="inventory-item-preview">
                ...
                <div class="product-preview small">
                    ...
                    <div class="product-preview-img-wrap">
                        ...
                        <a href="product-page.html">
                            <figure class="product-preview-img liquid">
                                <img src="{{ asset('themes/pixel-diamont-one/img/products/14.jpg') }}" alt="product-14">
                            </figure>
                        </a>
                        <!-- /PRODUCT PREVIEW IMG -->
                    </div>
        ...
        <ul class="mobile-menu">
            ...
            <li class="mobile-menu-item">
                <p class="mobile-menu-item-link pd-dropdown-handler">
                    <img class="widget-option-img user-avatar micro" src="{{ asset('themes/pixel-diamont-one/img/users/05.jpg') }}" alt="avatar-01">
                    James_Spiegel
                </p>
                <!-- ARROW ICON -->
                <svg class="arrow-icon medium">
                ...
                <div class="widget-options-wrap">
                    ...
                    <div id="lang-dropdown-trigger" class="current-option">
                        ...
                        <div id="lang-dropdown-option-value" class="current-option-value">
                            <img class="widget-option-img" src="{{ asset('themes/pixel-diamont-one/img/flags/flag-us.png') }}" alt="flag-us">
                    ...
                    <div id="lang-dropdown" class="widget-options small">
                        ...
                        <!-- WIDGET OPTION -->
                        <div class="widget-option">
                            <img class="widget-option-img" src="{{ asset('themes/pixel-diamont-one/img/flags/flag-es.png') }}" alt="flag-es">
                        ...
                        <!-- WIDGET OPTION -->
                        <div class="widget-option">
                            <img class="widget-option-img" src="{{ asset('themes/pixel-diamont-one/img/flags/flag-fr.png') }}" alt="flag-fr">
                        ...
                        <!-- WIDGET OPTION -->
                        <div class="widget-option">
                            <img class="widget-option-img" src="{{ asset('themes/pixel-diamont-one/img/flags/flag-jp.png') }}" alt="flag-jp">
                                        ...
                                        <div class="streamer-avatars">
                                            ...
                                            <div class="streamer-avatar">
                                                <a href="esports-streamers.html">
                                                    ...
                                                    <div class="streamer-avatar-img-wrap">
                                                        <!-- STREAMER AVATAR IMG -->
                                                        <img class="streamer-avatar-img" src="{{ asset('themes/pixel-diamont-one/img/streamers/streamer-hex-01.png') }}" alt="st-avatar-01">
                                                    </div>
                                                    <!-- /STREAMER AVATAR IMG WRAP -->
                                                </a>
                                            </div>
                                            ...
                                            <div class="streamer-avatar">
                                                <a href="esports-streamers.html">
                                                    ...
                                                    <div class="streamer-avatar-img-wrap">
                                                        <!-- STREAMER AVATAR IMG -->
                                                        <img class="streamer-avatar-img" src="{{ asset('themes/pixel-diamont-one/img/streamers/streamer-hex-02.png') }}" alt="st-avatar-02">
                                                    </div>
                                                    <!-- /STREAMER AVATAR IMG WRAP -->
                                                </a>
                                            </div>
                                            ...
                                            <div class="streamer-avatar">
                                                <a href="esports-streamers.html">
                                                    ...
                                                    <div class="streamer-avatar-img-wrap">
                                                        <!-- STREAMER AVATAR IMG -->
                                                        <img class="streamer-avatar-img" src="{{ asset('themes/pixel-diamont-one/img/streamers/streamer-hex-03.png') }}" alt="st-avatar-03">
                                                    </div>
                                                    <!-- /STREAMER AVATAR IMG WRAP -->
                                                </a>
                                            </div>
                                            ...
                                            <div class="streamer-avatar">
                                                <a href="esports-streamers.html">
                                                    ...
                                                    <div class="streamer-avatar-img-wrap">
                                                        <!-- STREAMER AVATAR IMG -->
                                                        <img class="streamer-avatar-img" src="{{ asset('themes/pixel-diamont-one/img/streamers/streamer-hex-04.png') }}" alt="st-avatar-04">
                                                    </div>
                                                    <!-- /STREAMER AVATAR IMG WRAP -->
                                                </a>
                                            </div>
                                            ...
                                            <div class="streamer-avatar">
                                                <a href="esports-streamers.html">
                                                    ...
                                                    <div class="streamer-avatar-img-wrap">
                                                        <!-- STREAMER AVATAR IMG -->
                                                        <img class="streamer-avatar-img" src="{{ asset('themes/pixel-diamont-one/img/streamers/streamer-hex-05.png') }}" alt="st-avatar-05">
                                                    </div>
                                                    <!-- /STREAMER AVATAR IMG WRAP -->
                                                </a>
                                            </div>
                                            ...
                                            <div class="widget-team-vs">
                                                ...
                                                <div class="widget-team-vs-item">
                                                    ...
                                                    <div class="team-info-wrap medium">
                                                        <!-- TEAM LOGO -->
                                                        <img class="team-logo" src="{{ asset('themes/pixel-diamont-one/img/teams/logos/01.png') }}" alt="logo-01">
                                                        <!-- /TEAM LOGO -->
                                                ...
                                                <div class="widget-team-vs-item">
                                                    ...
                                                    <div class="team-info-wrap medium">
                                                        <!-- TEAM LOGO -->
                                                        <img class="team-logo" src="{{ asset('themes/pixel-diamont-one/img/teams/logos/02.png') }}" alt="logo-02">
                                                        <!-- /TEAM LOGO -->
                                                ...
                                                <a href="esports-post.html">
                                                    <div class="post-preview-img-wrap">
                                                        ...
                                                        <figure class="post-preview-img liquid">
                                                            <img src="{{ asset('themes/pixel-diamont-one/img/posts/36.jpg') }}" alt="post-36">
                                                        </figure>
                                                        <!-- /POST PREVIEW IMG -->
                                                    </div>
                                                </a>
                                            ...
                                            <div class="post-preview tiny e-sport">
                                                ...
                                                <a href="esports-post.html">
                                                    <div class="post-preview-img-wrap">
                                                        <!-- POST PREVIEW IMG -->
                                                        <figure class="post-preview-img liquid">
                                                            <img src="{{ asset('themes/pixel-diamont-one/img/posts/38.jpg') }}" alt="post-38">
                                                        </figure>
                                                        <!-- /POST PREVIEW IMG -->
                                                    </div>
                                                </a>
                                            ...
                                            <div class="post-preview tiny e-sport">
                                                ...
                                                <a href="esports-post.html">
                                                    <div class="post-preview-img-wrap">
                                                        <!-- POST PREVIEW IMG -->
                                                        <figure class="post-preview-img liquid">
                                                            <img src="{{ asset('themes/pixel-diamont-one/img/posts/37.jpg') }}" alt="post-37">
                                                        </figure>
                                                        <!-- /POST PREVIEW IMG -->
                                                    </div>
                                                </a>
                                            ...
                                            <div class="post-preview tiny e-sport">
                                                ...
                                                <a href="esports-post.html">
                                                    <div class="post-preview-img-wrap">
                                                        <!-- POST PREVIEW IMG -->
                                                        <figure class="post-preview-img liquid">
                                                            <img src="{{ asset('themes/pixel-diamont-one/img/posts/39.jpg') }}" alt="post-39">
                                                        </figure>
                                                        <!-- /POST PREVIEW IMG -->
                                                    </div>
                                                </a>
                                            ...
                                            <div class="post-preview tiny e-sport">
                                                ...
                                                <a href="esports-post.html">
                                                    <div class="post-preview-img-wrap">
                                                        <!-- POST PREVIEW IMG -->
                                                        <figure class="post-preview-img liquid">
                                                            <img src="{{ asset('themes/pixel-diamont-one/img/posts/40.jpg') }}" alt="post-40">
                                                        </figure>
                                                        <!-- /POST PREVIEW IMG -->
                                                    </div>
                                                </a>
                                ...
                                <div class="post-preview gaming-news">
                                    ...
                                    <a href="post-v1.html">
                                        <div class="post-preview-img-wrap">
                                            <!-- POST PREVIEW IMG -->
                                            <figure class="post-preview-img liquid">
                                                <img src="{{ asset('themes/pixel-diamont-one/img/posts/09.jpg') }}" alt="post-09">
                                            </figure>
                                            <!-- /POST PREVIEW IMG -->
                                        </div>
                                    </a>
                                ...
                                <div class="post-preview game-review">
                                    ...
                                    <a href="post-v2.html">
                                        <div class="post-preview-img-wrap">
                                            <!-- POST PREVIEW IMG -->
                                            <figure class="post-preview-img liquid">
                                                <img src="{{ asset('themes/pixel-diamont-one/img/posts/08.jpg') }}" alt="post-08">
                                            </figure>
                                            <!-- /POST PREVIEW IMG -->
                                ...
                                <div class="post-preview geeky-news">
                                    ...
                                    <a href="post-v4.html">
                                        <div class="post-preview-img-wrap">
                                            <!-- POST PREVIEW IMG -->
                                            <figure class="post-preview-img liquid">
                                                <img src="{{ asset('themes/pixel-diamont-one/img/posts/02.jpg') }}" alt="post-02">
                                            </figure>
                                            <!-- /POST PREVIEW IMG -->
                                        </div>
                                    </a>
                                        ...
                                        <div class="submenu-slider-item submenu-slider-item-1">
                                            ...
                                            <div class="product-preview short">
                                                ...
                                                <div class="product-preview-img-wrap">
                                                    ...
                                                    <a href="product-page.html">
                                                        <figure class="product-preview-img liquid">
                                                            <img src="{{ asset('themes/pixel-diamont-one/img/products/04.jpg') }}" alt="product-04">
                                                        </figure>
                                                    </a>
                                                    <!-- /PRODUCT PREVIEW IMG -->
                                                </div>
                                        ...
                                        <div class="submenu-slider-item submenu-slider-item-2">
                                            ...
                                            <div class="product-preview short">
                                                ...
                                                <div class="product-preview-img-wrap">
                                                    ...
                                                    <a href="product-page.html">
                                                        <figure class="product-preview-img liquid">
                                                            <img src="{{ asset('themes/pixel-diamont-one/img/products/11.jpg') }}" alt="product-11">
                                                        </figure>
                                                    </a>
                                                    <!-- /PRODUCT PREVIEW IMG -->
                                                </div>
                                        ...
                                        <div class="submenu-slider-item submenu-slider-item-3">
                                            ...
                                            <div class="product-preview short">
                                                ...
                                                <div class="product-preview-img-wrap">
                                                    ...
                                                    <a href="product-page.html">
                                                        <figure class="product-preview-img liquid">
                                                            <img src="{{ asset('themes/pixel-diamont-one/img/products/09.jpg') }}" alt="product-09">
                                                        </figure>
                                                    </a>
                                                    <!-- /PRODUCT PREVIEW IMG -->
                                                </div>
                                        ...
                                        <div class="submenu-slider-item submenu-slider-item-4">
                                            ...
                                            <div class="product-preview short">
                                                ...
                                                <div class="product-preview-img-wrap">
                                                    ...
                                                    <a href="product-page.html">
                                                        <figure class="product-preview-img liquid">
                                                            <img src="{{ asset('themes/pixel-diamont-one/img/products/08.jpg') }}" alt="product-08">
                                                        </figure>
                                                    </a>
                                                    <!-- /PRODUCT PREVIEW IMG -->
                                                </div>
                                        ...
                                        <div class="submenu-slider-item submenu-slider-item-5">
                                            ...
                                            <div class="product-preview short">
                                                ...
                                                <div class="product-preview-img-wrap">
                                                    ...
                                                    <a href="product-page.html">
                                                        <figure class="product-preview-img liquid">
                                                            <img src="{{ asset('themes/pixel-diamont-one/img/products/07.jpg') }}" alt="product-07">
                                                        </figure>
                                                    </a>
                                                    <!-- /PRODUCT PREVIEW IMG -->
                                                </div>
                                        ...
                                        <div class="submenu-slider-item submenu-slider-item-6">
                                            ...
                                            <div class="product-preview short">
                                                ...
                                                <div class="product-preview-img-wrap">
                                                    ...
                                                    <a href="product-page.html">
                                                        <figure class="product-preview-img liquid">
                                                            <img src="{{ asset('themes/pixel-diamont-one/img/products/12.jpg') }}" alt="product-12">
                                                        </figure>
                                                    </a>
                                                    <!-- /PRODUCT PREVIEW IMG -->
                                                </div>
                                        ...
                                        <div class="submenu-slider-item submenu-slider-item-7">
                                            ...
                                            <div class="product-preview short">
                                                ...
                                                <div class="product-preview-img-wrap">
                                                    ...
                                                    <a href="product-page.html">
                                                        <figure class="product-preview-img liquid">
                                                            <img src="{{ asset('themes/pixel-diamont-one/img/products/13.jpg') }}" alt="product-13">
                                                        </figure>
                                                    </a>
                                                    <!-- /PRODUCT PREVIEW IMG -->
                                                </div>
    ...
    <div id="banner-slider-1" class="banner-slider">
        ...
        <div class="slider-items">
            ...
            @foreach( $carousel_images as $c => $carousel_image )
                <!-- SLIDER ITEM -->
                <div class="slider-item slider-item-{{ $c }}" style="background-image: url({{ $carousel_image->image_url }}); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                    <div class="slider-item-wrap">
                        <!-- POST PREVIEW -->
                        <div class="post-preview huge e-sport">
                            <!-- TAG ORNAMENT -->
                            ...
                            <!-- POST PREVIEW TITLE -->
                            <a href="{{ $carousel_image->link_url }}" class="post-preview-title">{{ $carousel_image->title }}</a>
                            <!-- POST PREVIEW TEXT -->
                            <p class="post-preview-text">{{ $carousel_image->description }}</p>
                            <!-- BUTTON -->
                            <a href="{{ $carousel_image->link_url }}" class="button big violet">
                                Ir al artículo
                                <!-- BUTTON ORNAMENT -->
                                <div class="button-ornament">
                                    <!-- ARROW ICON -->
    ...
    <div class="live-news-widget-wrap">
        ...
        <div class="live-news-widget grid-limit">
            ...
            <div class="live-news-widget-title-wrap">
                <img class="live-news-widget-icon" src="{{ asset('themes/pixel-diamont-one/img/icons/live-news-icon.png') }}" alt="live-news-icon">
                        ...
                        <div class="post-preview picture big game-review">
                            ...
                            <a href="post-v2.html">
                                <div class="post-preview-img-wrap">
                                    <!-- POST PREVIEW IMG -->
                                    <figure class="post-preview-img liquid">
                                        <img src="{{ asset('themes/pixel-diamont-one/img/customs/img-6.jpg') }}" alt="post-16">
                                    </figure>
                                    <!-- /POST PREVIEW IMG -->
                        ...
                        <div class="post-preview picture gaming-news">
                            ...
                            <a href="post-v1.html">
                                <div class="post-preview-img-wrap">
                                    <!-- POST PREVIEW IMG -->
                                    <figure class="post-preview-img liquid">
                                        <img src="{{ asset('themes/pixel-diamont-one/img/customs/img-3.jpeg') }}" alt="post-07">
                                    </figure>
                                    <!-- /POST PREVIEW IMG -->
                        ...
                        <div class="post-preview picture game-review">
                            ...
                            <a href="post-v2.html">
                                <div class="post-preview-img-wrap">
                                    <!-- POST PREVIEW IMG -->
                                    <figure class="post-preview-img liquid">
                                        <img src="{{ asset('themes/pixel-diamont-one/img/customs/img-3.webp') }}" alt="post-25">
                                    </figure>
                                    <!-- /POST PREVIEW IMG -->
                        ...
                        <div class="post-preview picture geeky-news">
                            ...
                            <a href="post-v4.html">
                                <div class="post-preview-img-wrap">
                                    <!-- POST PREVIEW IMG -->
                                    <figure class="post-preview-img liquid">
                                        <img src="{{ asset('themes/pixel-diamont-one/img/customs/img-5.jpg') }}" alt="post-18">
                                    </figure>
                                    <!-- /POST PREVIEW IMG -->
                        ...
                        <div class="post-preview big gaming-news">
                            ...
                            <a href="{{ route('post-show', [ 'slug' => $post->slug ]) }}">
                                <div class="post-preview-img-wrap">
                                    <!-- POST PREVIEW IMG -->
                                    <figure class="post-preview-img liquid">
                                        <img src="{{ $post->image_feature_url }}" alt="post-01">
                                    </figure>
                                    <!-- POST PREVIEW IMG -->
                                </div>
                            </a>
                            ...
                            <!-- POST PREVIEW TITLE -->
                            <a href="post-v1.html" class="post-preview-title"> {{ $post->title }} </a>
                            <!-- POST AUTHOR INFO -->
                            <div class="post-author-info-wrap">
                                <!-- USER AVATAR -->
                                <a href="search-results.html">
                                    <figure class="user-avatar tiny liquid">
                                        <img src="{{ asset('themes/pixel-diamont-one/img/users/01.jpg') }}" alt="user-01">
                                    </figure>
                                </a>
                                <!-- /USER AVATAR -->
                    ...
                    <div class="post-preview big gaming-news">
                        ...
                        <a href="post-v1.html">
                            <div class="post-preview-img-wrap">
                                <!-- POST PREVIEW IMG -->
                                <figure class="post-preview-img liquid">
                                    <img src="{{ asset('themes/pixel-diamont-one/img/customs/img-5.jpg') }}" alt="post-01">
                                </figure>
                                <!-- POST PREVIEW IMG -->
                            </div>
                        </a>
                        ...
                        <!-- /POST AUTHOR INFO -->
                        <!-- POST PREVIEW TEXT -->
                        <p class="post-preview-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt dutor et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation loso laboris tempora aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat pidatat.</p>
                    </div>
                    <!-- /POST PREVIEW -->
                    ...
                    <div class="post-preview big game-review">
                        ...
                        <a href="post-v2.html">
                            <div class="post-preview-img-wrap">
                                <!-- POST PREVIEW IMG -->
                                <figure class="post-preview-img liquid">
                                    <img src="{{ asset('themes/pixel-diamont-one/img/customs/img-6.jpg') }}" alt="post-05">
                                </figure>
                                <!-- POST PREVIEW IMG -->
                        ...
                        <div class="post-author-info-wrap">
                            ...
                            <a href="search-results.html">
                                <figure class="user-avatar tiny liquid">
                                    <img src="{{ asset('themes/pixel-diamont-one/img/users/04.jpg') }}" alt="user-04">
                                </figure>
                            </a>
                            <!-- /USER AVATAR -->
                            <p class="post-author-info small light">By <a href="search-results.html" class="post-author">Vellatrix</a><span class="separator">|</span>December 15th, 2018<span class="separator">|</span><a href="post-v2.html#op-comments" class="post-comment-count">258 Comments</a></p>
                        </div>
                        <!-- /POST AUTHOR INFO -->
                        <!-- POST PREVIEW TEXT -->
                        <p class="post-preview-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt dutor et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation loso laboris tempora aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat pidatat.</p>
                    ...
                    <div class="post-preview gaming-news img-toggle">
                        ...
                        <a href="post-v1.html">
                            <div class="post-preview-img-wrap">
                                <!-- POST PREVIEW IMG -->
                                <figure class="post-preview-img liquid">
                                    <img src="{{ asset('themes/pixel-diamont-one/img/customs/img-8.jpg') }}" alt="post-17">
                                </figure>
                                <!-- /POST PREVIEW IMG -->
                            </div>
                        </a>
                    ...
                    <div class="post-preview gaming-news img-toggle">
                        ...
                        <a href="post-v1.html">
                            <div class="post-preview-img-wrap">
                                <!-- POST PREVIEW IMG -->
                                <figure class="post-preview-img liquid">
                                    <img src="{{ asset('themes/pixel-diamont-one/img/customs/img-1.avif') }}" alt="post-09">
                                </figure>
                                <!-- /POST PREVIEW IMG -->
                            </div>
                        </a>
                ...
                <div class="post-preview-showcase">
                    ...
                    <div class="post-preview-showcase">
                        ...
                        <div class="post-preview gaming-news">
                            ...
                            <a href="post-v1.html">
                                <div class="post-preview-img-wrap">
                                    <!-- POST PREVIEW IMG -->
                                    <figure class="post-preview-img liquid">
                                        <img src="{{ asset('themes/pixel-diamont-one/img/customs/img-7.jpg') }}" alt="post-20">
                                    </figure>
                                    <!-- /POST PREVIEW IMG -->
                                </div>
                            </a>
                            ...
                            <!-- POST PREVIEW TITLE -->
                            <a href="post-v1.html" class="post-preview-title">Legend of the Temple is coming to all consoles</a>
                            <!-- POST AUTHOR INFO -->
                            <div class="post-author-info-wrap">
                                <p class="post-author-info small light">By <a href="search-results.html" class="post-author">Vellatrix</a><span class="separator">|</span>December 15th, 2018</p>
                            </div>
                        ...
                        <div class="post-preview small gaming-news">
                            <!-- POST PREVIEW TITLE -->
                            <a href="post-v1.html" class="post-preview-title">Pro Soccer 2017 is gonna run with a new graphics engine</a>
                            <!-- POST AUTHOR INFO -->
                            <div class="post-author-info-wrap">
                                <p class="post-author-info small light">By <a href="search-results.html" class="post-author">Dexter</a><span class="separator">|</span>December 15th, 2018</p>
                            </div>
                            <!-- /POST AUTHOR INFO -->
                        </div>
                        <!-- /POST PREVIEW -->
                        ...
                        <div class="post-preview small gaming-news">
                            <!-- POST PREVIEW TITLE -->
                            <a href="post-v1.html" class="post-preview-title">Thomas Barker joins the team of "The Amazing Knight"</a>
                            <!-- POST AUTHOR INFO -->
                            <div class="post-author-info-wrap">
                                <p class="post-author-info small light">By <a href="search-results.html" class="post-author">Dexter</a><span class="separator">|</span>December 15th, 2018</p>
                            </div>
                ...
                <div class="post-preview-showcase">
                    ...
                    <div class="post-preview-showcase">
                        ...
                        <div class="post-preview game-review">
                            ...
                            <a href="post-v2.html">
                                <div class="post-preview-img-wrap">
                                    <!-- POST PREVIEW IMG -->
                                    <figure class="post-preview-img liquid">
                                        <img src="{{ asset('themes/pixel-diamont-one/img/customs/img-5.webp') }}" alt="post-10">
                                    </figure>
                                    <!-- /POST PREVIEW IMG -->
                            ...
                            <!-- POST PREVIEW TITLE -->
                            <a href="post-v2.html" class="post-preview-title">Dragons and Knights arrived with a big impression</a>
                            <!-- POST AUTHOR INFO -->
                            <div class="post-author-info-wrap">
                                <p class="post-author-info small light">By <a href="search-results.html" class="post-author">Vellatrix</a><span class="separator">|</span>December 15th, 2018</p>
                            </div>
                        ...
                        <div class="post-preview small game-review">
                            <!-- POST PREVIEW TITLE -->
                            <a href="post-v2.html" class="post-preview-title">The new Mary World lacks the fun and charm of older versions</a>
                            <!-- POST AUTHOR INFO -->
                            <div class="post-author-info-wrap">
                        ...
                        <div class="post-preview small game-review">
                            <!-- POST PREVIEW TITLE -->
                            <a href="post-v2.html" class="post-preview-title">We played Pirates Greed Japan and has the potential to be GOTY</a>
                            <!-- POST AUTHOR INFO -->
                            <div class="post-author-info-wrap">
                                <p class="post-author-info small light">By <a href="search-results.html" class="post-author">Vellatrix</a><span class="separator">|</span>December 15th, 2018</p>
                            </div>
                ...
                <div class="post-preview-showcase">
                    ...
                    <div class="post-preview-showcase">
                        ...
                        <div class="post-preview small geeky-news">
                            <!-- POST PREVIEW TITLE -->
                            <a href="post-v4.html" class="post-preview-title">Plans for a new AC theme park in California studios</a>
                            <!-- POST AUTHOR INFO -->
                            <div class="post-author-info-wrap">
                                <p class="post-author-info small light">By <a href="search-results.html" class="post-author">Morgana</a><span class="separator">|</span>December 15th, 2018</p>
                            </div>
                        ...
                        <div class="post-preview small geeky-news">
                            <!-- POST PREVIEW TITLE -->
                            <a href="post-v4.html" class="post-preview-title">Jessica Tam to appear at this year Bebop convention</a>
                            <!-- POST AUTHOR INFO -->
                            <div class="post-author-info-wrap">
                                <p class="post-author-info small light">By <a href="search-results.html" class="post-author">Vellatrix</a><span class="separator">|</span>December 15th, 2018</p>
                            </div>
            ...
            <div class="layout-item padded">
                <a href="#">
                    ...
                    <div class="promo-banner">
                        <!-- PROMO BANNER IMG -->
                        <img src="{{ asset('themes/pixel-diamont-one/img/banners/live-play-banner-logo.png') }}" alt="promo-banner-img" class="promo-banner-img">
                        <!-- /PROMO BANNER IMG -->
            ...
            <div class="layout-item padded own-grid">
                ...
                <div id="lvideos-slider1" class="carousel video">
                    ...
                    <div class="carousel-items">
                        ...
                        @foreach( $videos as $c => $chunk )

                            <!-- CAROUSEL ITEM -->
                            <div class="carousel-item">

                                @foreach( $chunk as $v => $video )
                                    ...
                                    <div class="post-preview video">
                                        ...
                                        <a href="{{ route('video-show', [ 'id' => $video->id ]) }}">
                                            <div class="post-preview-img-wrap">
                                                <!-- POST PREVIEW IMG -->
                                                <figure class="post-preview-img liquid">
                                                    <img src="{{ $video->image_url }}" alt="post-17">
                                                </figure>
                                                <!-- /POST PREVIEW IMG -->
                                                ...
                                                <div class="post-preview-overlay">
                                                    ...
                                                    <div class="post-preview-overlay-info">
                                                        <!-- POST PREVIEW TITLE -->
                                                        <p class="post-preview-title">{{ $video->title }}</p>
                                                        <!-- POST PREVIEW TEXT -->
                                                        <p class="post-preview-text">{{ $video->description }}</p>
                                                    </div>
                                                    <!-- /POST PREVIEW OVERLAY INFO -->
                                                </div>
                                                <!-- /POST PREVIEW OVERLAY -->
                            ...
                            <div class="post-preview video">
                                ...
                                <a href="post-video.html">
                                    <div class="post-preview-img-wrap">
                                        <!-- POST PREVIEW IMG -->
                                        <figure class="post-preview-img liquid">
                                            <img src="{{ asset('themes/pixel-diamont-one/img/posts/17.jpg') }}" alt="post-17">
                                        </figure>
                                        <!-- /POST PREVIEW IMG -->
                                        ...
                                        <div class="post-preview-overlay">
                                            ...
                                            <div class="post-preview-overlay-info">
                                                <!-- POST PREVIEW TITLE -->
                                                <p class="post-preview-title">Jazzstar announced that the GTE5 for PC is delayed</p>
                                                <!-- POST PREVIEW TEXT -->
                            ...
                            <div class="post-preview video">
                                ...
                                <a href="post-video.html">
                                    <div class="post-preview-img-wrap">
                                        <!-- POST PREVIEW IMG -->
                                        <figure class="post-preview-img liquid">
                                            <img src="{{ asset('themes/pixel-diamont-one/img/posts/01.jpg') }}" alt="post-01">
                                        </figure>
                                        <!-- /POST PREVIEW IMG -->
                                        ...
                                        <div class="post-preview-overlay">
                                            ...
                                            <div class="post-preview-overlay-info">
                                                <!-- POST PREVIEW TITLE -->
                                                <p class="post-preview-title">The Clash of Dragons is breaking record sales in...</p>
                                                <!-- POST PREVIEW TEXT -->
                                                <p class="post-preview-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
                                            </div>
                                            <!-- /POST PREVIEW OVERLAY INFO -->
                            ...
                            <div class="post-preview video">
                                ...
                                <a href="post-video.html">
                                    <div class="post-preview-img-wrap">
                                        <!-- POST PREVIEW IMG -->
                                        <figure class="post-preview-img liquid">
                                            <img src="{{ asset('themes/pixel-diamont-one/img/posts/07.jpg') }}" alt="post-07">
                                        </figure>
                                        <!-- /POST PREVIEW IMG -->
                            ...
                            <div class="post-preview video">
                                ...
                                <a href="post-video.html">
                                    <div class="post-preview-img-wrap">
                                        <!-- POST PREVIEW IMG -->
                                        <figure class="post-preview-img liquid">
                                            <img src="{{ asset('themes/pixel-diamont-one/img/posts/16.jpg') }}" alt="post-16">
                                        </figure>
                                        <!-- /POST PREVIEW IMG -->
                            ...
                            <div class="post-preview video">
                                ...
                                <a href="post-video.html">
                                    <div class="post-preview-img-wrap">
                                        <!-- POST PREVIEW IMG -->
                                        <figure class="post-preview-img liquid">
                                            <img src="{{ asset('themes/pixel-diamont-one/img/posts/12.jpg') }}" alt="post-12">
                                        </figure>
                                        <!-- /POST PREVIEW IMG -->
                            ...
                            <div class="post-preview video">
                                ...
                                <a href="post-video.html">
                                    <div class="post-preview-img-wrap">
                                        <!-- POST PREVIEW IMG -->
                                        <figure class="post-preview-img liquid">
                                            <img src="{{ asset('themes/pixel-diamont-one/img/posts/13.jpg') }}" alt="post-13">
                                        </figure>
                                        <!-- /POST PREVIEW IMG -->
                    ...
                    <div class="post-preview tiny game-review">
                        ...
                        <a href="post-v2.html">
                            <div class="post-preview-img-wrap">
                                <!-- POST PREVIEW IMG -->
                                <figure class="post-preview-img liquid">
                                    <img src="{{ asset('themes/pixel-diamont-one/img/posts/25.jpg') }}" alt="post-25">
                                </figure>
                                <!-- /POST PREVIEW IMG -->
                    ...
                    <div class="post-preview tiny game-review">
                        ...
                        <a href="post-v2.html">
                            <div class="post-preview-img-wrap">
                                <!-- POST PREVIEW IMG -->
                                <figure class="post-preview-img liquid">
                                    <img src="{{ asset('themes/pixel-diamont-one/img/posts/05.jpg') }}" alt="post-05">
                                </figure>
                                <!-- /POST PREVIEW IMG -->
                    ...
                    <div class="post-preview tiny game-review">
                        ...
                        <a href="post-v2.html">
                            <div class="post-preview-img-wrap">
                                <!-- POST PREVIEW IMG -->
                                <figure class="post-preview-img liquid">
                                    <img src="{{ asset('themes/pixel-diamont-one/img/posts/088.jpg') }}" alt="post-08">
                                </figure>
                                <!-- /POST PREVIEW IMG -->
                ...
                <div class="stream-preview-showcase grid-1col centered gutter-small">
                    ...
                    <div class="stream-preview">
                        ...
                        <div class="stream-preview-streamer stream-preview-streamer-1">
                            ...
                            <img class="stream-preview-streamer-img" src="{{ asset('themes/pixel-diamont-one/img/streamers/streambox-01-streamer.png') }}" alt="streambox-01-streamer">
                            <!-- /STREAM PREVIEW STREAMER IMG -->
                    ...
                    <div class="stream-preview">
                        ...
                        <div class="stream-preview-streamer stream-preview-streamer-2">
                            <!-- STREAM PREVIEW STREAMER IMG -->
                            <img class="stream-preview-streamer-img" src="{{ asset('themes/pixel-diamont-one/img/streamers/streambox-02-streamer.png') }}" alt="streambox-02-streamer">
                            <!-- /STREAM PREVIEW STREAMER IMG -->
                    ...
                    <div class="stream-preview">
                        ...
                        <div class="stream-preview-streamer stream-preview-streamer-3">
                            <!-- STREAM PREVIEW STREAMER IMG -->
                            <img class="stream-preview-streamer-img" src="{{ asset('themes/pixel-diamont-one/img/streamers/streambox-03-streamer.png') }}" alt="streambox-03-streamer">
                            <!-- /STREAM PREVIEW STREAMER IMG -->
                ...
                <div class="comment-preview-showcase grid-1col centered gutter-medium">
                    ...
                    <div class="comment-preview">
                        ...
                        <a href="post-v4.html#op-comments">
                            <img class="user-avatar" src="{{ asset('themes/pixel-diamont-one/img/users/06.jpg') }}" alt="user-06">
                        </a>
                        <!-- /USER AVATAR -->
                    ...
                    <div class="comment-preview">
                        ...
                        <a href="post-v1.html#op-comments">
                            <img class="user-avatar" src="{{ asset('themes/pixel-diamont-one/img/users/07.jpg') }}" alt="user-07">
                        </a>
                        <!-- /USER AVATAR -->
                    ...
                    <div class="comment-preview">
                        ...
                        <a href="post-v3.html#op-comments">
                            <img class="user-avatar" src="{{ asset('themes/pixel-diamont-one/img/users/02.jpg') }}" alt="user-02">
                        </a>
                        <!-- /USER AVATAR -->
                    ...
                    <div class="post-preview video">
                        ...
                        <a href="post-video.html">
                            <div class="post-preview-img-wrap">
                                <!-- POST PREVIEW IMG -->
                                <figure class="post-preview-img liquid">
                                    <img src="{{ asset('themes/pixel-diamont-one/img/posts/03.jpg') }}" alt="post-03">
                                </figure>
                                <!-- /POST PREVIEW IMG -->
                    ...
                    <div id="footer-sponsor-slider" class="sponsors-slider">
                        ...
                        <div class="sponsors-slider-items">
                            ...
                            <div class="sponsors-slider-item">
                                <img class="sponsor-img" src="{{ asset('themes/pixel-diamont-one/img/sponsors/sponsor01.png') }}" alt="sponsor01">
                            </div>
                            <!-- /SPONSORS SLIDER ITEM -->

                            <!-- SPONSORS SLIDER ITEM -->
                            <div class="sponsors-slider-item">
                                <img class="sponsor-img" src="{{ asset('themes/pixel-diamont-one/img/sponsors/sponsor02.png') }}" alt="sponsor02">
                            </div>
                            <!-- /SPONSORS SLIDER ITEM -->

                            <!-- SPONSORS SLIDER ITEM -->
                            <div class="sponsors-slider-item">
                                <img class="sponsor-img" src="{{ asset('themes/pixel-diamont-one/img/sponsors/sponsor03.png') }}" alt="sponsor03">
                            </div>
                            <!-- /SPONSORS SLIDER ITEM -->

                            <!-- SPONSORS SLIDER ITEM -->
                            <div class="sponsors-slider-item">
                                <img class="sponsor-img" src="{{ asset('themes/pixel-diamont-one/img/sponsors/sponsor04.png') }}" alt="sponsor04">
                            </div>
                            <!-- /SPONSORS SLIDER ITEM -->

                            <!-- SPONSORS SLIDER ITEM -->
                            <div class="sponsors-slider-item">
                                <img class="sponsor-img" src="{{ asset('themes/pixel-diamont-one/img/sponsors/sponsor05.png') }}" alt="sponsor05">
                            </div>
                            <!-- /SPONSORS SLIDER ITEM -->

                            <!-- SPONSORS SLIDER ITEM -->
                            <div class="sponsors-slider-item">
                                <img class="sponsor-img" src="{{ asset('themes/pixel-diamont-one/img/sponsors/sponsor06.png') }}" alt="sponsor06">
                            </div>
                            <!-- /SPONSORS SLIDER ITEM -->
                        </div>
                        <!-- /SPONSORS SLIDER ITEMS -->
                    ...
                    <div class="product-preview-showcase grid-1col gutter-small">
                        ...
                        <div class="product-preview tiny negative">
                            ...
                            <div class="product-preview-img-wrap">
                                ...
                                <a href="product-page.html">
                                    <figure class="product-preview-img liquid">
                                        <img src="{{ asset('themes/pixel-diamont-one/img/products/03.jpg') }}" alt="product-03">
                                    </figure>
                                </a>
                                <!-- /PRODUCT PREVIEW IMG -->
                            </div>
    ...
    <!-- app bundle -->
    <script src="{{ asset('themes/pixel-diamont-one/app.bundle.min.js') }}"></script>
